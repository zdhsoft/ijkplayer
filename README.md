...
- Android
 ...
 - Gradle 2.14.1 (请注意，不要升级gradle, 会报一堆的错和修改的地方。android studio给出提示的时候，选择保存当前的gradle即可)
- iOS
 - Xcode 7.3 (7D175)
...
- Android
 ...
 - hw-decoder: MediaCodec (API 16+, Android 4.1+,  目前发现，华为海思的盒子支持不错，CPU：hi3798M，当前市面上的魔百盒 CM101s android 4.4，就可以。支持h265 4k的硬件，6666)；
...
#注意在ubuntu下，主要用sh init-android.sh来执行，会报错。
./init-android.sh
